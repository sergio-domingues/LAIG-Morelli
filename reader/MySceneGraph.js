...
MySceneGraph.prototype.parseInitials = function(rootElement) {
    ...
    this.scene.frustum = {
        near: this.reader.getFloat(frustum[0], "near", true),
    ...
    var translation = {
        x: this.reader.getFloat(translate[0], "x", true),
    ...
    var scale_initial = {
        sx: this.reader.getFloat(scale[0], "sx", true),
...
MySceneGraph.prototype.parseIlumination = function(rootElement) {
    ...
    this.scene.ambient = {
        r: this.reader.getFloat(ambient[0], "r", true),
    ...
    this.scene.background = {
        r: this.reader.getFloat(background[0], "r", true),
...
MySceneGraph.prototype.parseLights = function(rootElement) {
    ...
    for (var i = 0; i < lightsList.length; i++) {
        ...
        var positionList = {
            x: this.reader.getFloat(pos[0], "x", true),
        ...
        var diffuseList = {
            r: this.reader.getFloat(diffuse[0], "r", true),
        ...
        var specullarList = {
            r: this.reader.getFloat(specullar[0], "r", true),
...
MySceneGraph.prototype.parseTextures = function(rootElement) {
    ...
    this.scene.textures = new assocMap();
    //boa pratica
    ...
    for (var i = 0; i < texturesList.length; i++) {
        ...
        this.scene.textures.add(id, new MyTexture(this.scene,url,amplif_s,amplif_t,id));
        //carrega elemento "texture" para arraya associativo
    }
}
;
...
MySceneGraph.prototype.parseMaterials = function(rootElement) {
    ...
    for (var i = 0; i < materialsList.length; i++) {
        ...
        var emissionList = {
            r: this.reader.getFloat(emission[0], "r", true),
        ...
        this.scene.materials.add(id, material_Obj);
        //carrega elemento "material" para arraya associativo
    }
}
;
...
MySceneGraph.prototype.parseNodes = function(rootElement) {
    ...
    for (var i = 0; i < nodeslist.length; i++) {
        ...
        for (var j = 0; j < childList_length; j++) {
            ...
            } else if (child.noName == "DESCENDANTS")
